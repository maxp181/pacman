function checkCollisions(pacman, listOfGhosts, dots, powers) {
...
function createGame() {
    ...
    return new PacmanGame(new Pacman(true, "left", gc.start, 3),
      [new Ghost("blinky", "up", new Posn(5, 4), 0, true, 0),
        new Ghost("clyde", "up", new Posn(20, 4), 0, true, 0),
        new Ghost("inky", "up", new Posn(5, 20), 0, true, 0),
        new Ghost("pinky", "up", new Posn(20, 20), 0, true, 0)
      ],
      gc);
  }
  ...
  function initializeDots() {
    return [new Posn(0, 0), new Posn(0, 1), new Posn(0, 3), new Posn(0, 4), new Posn(0, 5), new Posn(0, 6),
      ...
      new Posn(25, 7), new Posn(25, 19), new Posn(25, 20), new Posn(25, 21), new Posn(25, 25), new Posn(25, 2),
